# UdacityCloudDevops062020
Cloud Devops Engineer Udacity project 2

In this project for the Udacity nanodegree for Cloud Devops Engineer using AWS, we deployed a high availability web app using cloudformation.  
